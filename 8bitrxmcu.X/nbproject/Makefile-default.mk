...
FINAL_IMAGE=${DISTDIR}/8bitrxmcu.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/8bitrxmcu.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
